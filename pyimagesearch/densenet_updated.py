...
def densenet_model(img_rows, img_cols, color_type=1, nb_dense_block=4, growth_rate=32, nb_filter=64, reduction=0.5, dropout_rate=0.0, weight_decay=1e-4, num_classes=None):
    '''
    ...
    nb_filter = nb_filter
    nb_layers = [6, 8, 8, 8] # For DenseNet-121
